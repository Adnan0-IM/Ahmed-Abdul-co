      ...
      <div className="relative  z-10  ">
        <div className="container mx-auto px-4 lg:px-8 ">
          <div className="flex flex-col text-center items-center md:items-start md:text-start gap-6 py-24  md:w-1/2 text-white">
            ...
            {buttonText && (
              <Link
                className="bg-primary-light mt-2 md:mt-0 shadow-md hover:scale-105 w-[220px] transition-all duration-200 hover:bg-primary-dark text-center font-medium p-3 md:p-4 rounded-md  "
                to="/services"
              >
                {buttonText}
              </Link>
